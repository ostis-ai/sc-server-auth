...
from json_client.constants.numeric import LOGGING_MAX_SIZE, SERVER_ANSWER_CHECK_TIME, SERVER_ESTABLISH_CONNECTION_TIME
...
from json_client.sc_module import unregister_sc_modules
...
def _on_message(ws: websocket.WebSocketApp, response: str) -> None:  # pylint: disable=W0613
...
def _on_error(ws: websocket.WebSocketApp, error: Exception) -> None:  # pylint: disable=W0613
    disconnect()
